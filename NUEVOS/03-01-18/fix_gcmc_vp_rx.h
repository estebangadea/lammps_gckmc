...
class FixGCMCVp : public Fix {
 public:
  ...
  void attempt_atomic_foward_full();
  void attempt_atomic_reverse_full();
  ...
  int pick_random_reactive_atom();
  int pick_random_product_atom();
 ...
 private:
  ...
  int typeR, typeP,steqR,steqP; //added by Yamila 
  int neveryrx,nrx,seedrx; // added by Yamila 
  int ngas;                 // # of gas atoms on all procs
  int ngas_local;           // # of gas atoms on this proc
  int ngas_before;          // # of gas atoms on procs < this proc
  int nr;                 // # of reactive atoms on all procs
  int nr_local;           // # of reactive atoms on this proc
  int nr_before;          // # of reactive atoms on procs < this proc
  int np;                 // # of product atoms on all procs
  int np_local;           // # of product atoms on this proc
  int np_before;          // # of product atoms on procs < this proc
  ...
  double nfoward_attempts;
  double nfoward_successes;
  double nreverse_attempts;
  double nreverse_successes;
  ...
  double *sublo,*subhi;
  int *local_gas_list;
  int *local_product_list;
  int *local_reactive_list;
  double **cutsq;
  double **atom_coord;
  imageint imagezero;
