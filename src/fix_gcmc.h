...
class FixGCMC : public Fix {
 public:
  ...
  void attempt_atomic_deletion_full();    // commented out by Jibao; just for debugging
    //void attempt_atomic_deletion_full(int flag = 0);    // added by Jibao; just for debugging
