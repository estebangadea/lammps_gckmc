...
PairSW0OMP::PairSW0OMP(LAMMPS *lmp) :
  PairSW0(lmp), ThrOMP(lmp, THR_PAIR)
{
...
void PairSW0OMP::compute(int eflag, int vflag)
{
  if (eflag || vflag) {
...
void PairSW0OMP::eval(int iifrom, int iito, ThrData * const thr)
{
...
double PairSW0OMP::memory_usage()
{
  double bytes = memory_usage_thr();
  bytes += PairSW0::memory_usage();
