...
class Pair : protected Pointers {
 ...
 public:
  ...
  virtual double single(int, int, int, int,
    ...
    virtual void *returnmap() {return NULL;}  // added by Jibao. For sw or sw0 or swl only; for energy() in fix_gcmc_vp.cpp, or for relative entropy minimization
    
    virtual void *returnmap_substyle() {return NULL;}  // added by Jibao. For sw or sw0 only; for energy() in fix_gcmc_vp.cpp
    
    virtual void *returnstyles() {return NULL;}  // added by Jibao. For sw or sw0 only; for energy() in fix_gcmc_vp.cpp
    
    virtual void *returnkeywords() {return NULL;}  // added by Jibao. For sw or sw0 only; for energy() in fix_gcmc_vp.cpp
    
    virtual void *returnelem2param() {return NULL;}   // added by Jibao. For sw or sw0 or swl only; for energy() in fix_gcmc_vp.cpp, or for relative entropy minimization
    
    virtual void *returnparams() {return NULL;}   // added by Jibao. For sw or sw0 only; for energy() in fix_gcmc_vp.cpp
    
    virtual void *returnnmap() {return NULL;}   // added by Jibao; nmap: # of sub-styles itype,jtype points to
    ...
    virtual void twobody(Param *, double, double &, int, double &) {}   // added by Jibao. For sw or sw0 only; for energy() in fix_gcmc_vp.cpp
    virtual void threebody(Param *, Param *, Param *, double, double, double *, double *,
                           double *, double *, int, double &) {}  // added by Jibao. For sw or sw0 only; for energy() in fix_gcmc_vp.cpp
