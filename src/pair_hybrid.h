...
class PairHybrid : public Pair {
 ...
 public:
  ...
  int check_ijtype(int, int, char *);
    ...
    void *returnmap_substyle();   // added by Jibao; note that ***map is a protected pointer
    
    void *returnstyles();   // added by Jibao; note that **styles is a protected pointer
    
    void *returnkeywords();   // added by Jibao; note that ***map is a protected pointer
    
    void *returnnmap();   // added by Jibao; nmap: # of sub-styles itype,jtype points to
