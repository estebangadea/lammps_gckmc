...
FixStyle(conc,FixConc)

#else

#ifndef LMP_FIX_CONC_H
#define LMP_FIX_CONC_H
...
class FixConc : public Fix {
 public:
  FixConc(class LAMMPS *, int, char **);
  ~FixConc();
  int setmask();
  void init();
  void pre_exchange();
  ...
  void attempt_label_change(); //Esteban
